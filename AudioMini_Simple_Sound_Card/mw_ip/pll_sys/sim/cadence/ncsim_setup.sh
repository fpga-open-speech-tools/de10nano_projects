...
mkdir -p ./libraries/pll_sys_altera_iopll_180/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS   "$QSYS_SIMDIR/../altera_iopll_180/sim/pll_sys_altera_iopll_180_hm2x5zi.vo" -work pll_sys_altera_iopll_180 -cdslib ./cds_libs/pll_sys_altera_iopll_180.cds.lib
  ncvhdl -v93 $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/pll_sys.vhd"                                                                                                                                   
fi
