...
# ----------------------------------------
# ACDS 18.0 614 win32 2018.07.17.11:44:18
...
ensure_lib                          ./libraries/pll_sys_altera_iopll_180/
vmap       pll_sys_altera_iopll_180 ./libraries/pll_sys_altera_iopll_180/
...
alias com {
  echo "\[exec\] com"
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../altera_iopll_180/sim/pll_sys_altera_iopll_180_hm2x5zi.vo" -work pll_sys_altera_iopll_180
  eval  vcom $USER_DEFINED_VHDL_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS    "$QSYS_SIMDIR/pll_sys.vhd"                                                                               
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L pll_sys_altera_iopll_180 -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L twentynm_ver -L twentynm_hssi_ver -L twentynm_hip_ver -L altera -L lpm -L sgate -L altera_mf -L altera_lnsim -L twentynm -L twentynm_hssi -L twentynm_hip $TOP_LEVEL_NAME
}
