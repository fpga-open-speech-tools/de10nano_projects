...
create_clock -name {serial_clk} -period "12.288 MHz" [get_ports {Audio_Mini_GPIO_0[3]}]
...
set_multicycle_path -from [get_clocks {FPGA_CLK1_50}] -to [get_clocks {u0|pll_using_ad1939_mclk|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}] -setup -end 2
set_multicycle_path -from [get_clocks {FPGA_CLK1_50}] -to [get_clocks {u0|pll_using_ad1939_mclk|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}] -hold -end 1
set_multicycle_path -from [get_clocks {FPGA_CLK1_50}] -to [get_clocks {u0|pll_using_ad1939_mclk|altera_pll_i|general[2].gpll~PLL_OUTPUT_COUNTER|divclk}] -setup -start 2
set_multicycle_path -from [get_clocks {FPGA_CLK1_50}] -to [get_clocks {u0|pll_using_ad1939_mclk|altera_pll_i|general[2].gpll~PLL_OUTPUT_COUNTER|divclk}] -hold -start 1
set_multicycle_path -from [get_clocks {serial_clk}] -to [get_clocks {u0|pll_using_ad1939_mclk|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}] -setup -end 2
set_multicycle_path -from [get_clocks {serial_clk}] -to [get_clocks {u0|pll_using_ad1939_mclk|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}] -hold -end 1

set_multicycle_path -from [get_clocks {FPGA_CLK1_50}] -to [get_clocks {serial_clk}] -setup -start 2
set_multicycle_path -from [get_clocks {FPGA_CLK1_50}] -to [get_clocks {serial_clk}] -hold  -start 1

set_multicycle_path -from [get_clocks {serial_clk}] -to [get_clocks {FPGA_CLK1_50}] -setup -end 2
set_multicycle_path -from [get_clocks {serial_clk}] -to [get_clocks {FPGA_CLK1_50}] -hold -end 1

#  REMOVE THESE AFTER REMOVING SIGNAL TAP
# set_multicycle_path -from [get_clocks {serial_clk}] -to [get_clocks {u0|pll_using_ad1939_mclk|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}] -setup -start 2
# set_multicycle_path -from [get_clocks {serial_clk}] -to [get_clocks {u0|pll_using_ad1939_mclk|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}] -hold -start 1
