...
# set_multicycle_path -from {soc_system:u0|altera_reset_controller:rst_controller|altera_reset_synchronizer:alt_rst_sync_uq1|altera_reset_synchronizer_int_chain_out} -to {soc_system:u0|FE_Qsys_Simple_HA:fe_qsys_simple_ha_0|audio_clk_counter[*]} -setup 2
# set_multicycle_path -from {soc_system:u0|altera_reset_controller:rst_controller|altera_reset_synchronizer:alt_rst_sync_uq1|altera_reset_synchronizer_int_chain_out} -to {soc_system:u0|FE_Qsys_Simple_HA:fe_qsys_simple_ha_0|audio_clk_counter[*]} -hold 1
