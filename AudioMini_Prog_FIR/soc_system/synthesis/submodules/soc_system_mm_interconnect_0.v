...
module soc_system_mm_interconnect_0 (
	...
	wire   [29:0] onchip_memory_s1_agent_m0_address;                    // onchip_memory_s1_agent:m0_address -> onchip_memory_s1_translator:uav_address
	...
	wire  [159:0] onchip_memory_s1_agent_rf_source_data;                // onchip_memory_s1_agent:rf_source_data -> onchip_memory_s1_agent_rsp_fifo:in_data
	...
	wire  [159:0] onchip_memory_s1_agent_rsp_fifo_out_data;             // onchip_memory_s1_agent_rsp_fifo:out_data -> onchip_memory_s1_agent:rf_sink_data
	...
	wire  [158:0] onchip_memory_s1_agent_rp_data;                       // onchip_memory_s1_agent:rp_data -> router_002:sink_data
	...
	wire  [158:0] cmd_mux_src_data;                                     // cmd_mux:src_data -> onchip_memory_s1_burst_adapter:sink0_data
	wire          cmd_mux_src_ready;                                    // onchip_memory_s1_burst_adapter:sink0_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                  // cmd_mux:src_channel -> onchip_memory_s1_burst_adapter:sink0_channel
	...
	wire  [158:0] onchip_memory_s1_burst_adapter_source0_data;          // onchip_memory_s1_burst_adapter:source0_data -> onchip_memory_s1_agent:cp_data
